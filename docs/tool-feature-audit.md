...
1. Quét bài viết Threads theo niche.
...
- Xóa niche.
- Bật hoặc tắt niche.
- Fetch thủ công từng niche.
- Bật quét nền khi app đang chạy.

Ví dụ niche phù hợp thị trường Việt Nam:
...
1. Lấy tối đa 12 niche đang bật.
2. Fetch tối đa 14 bài cho mỗi niche.
3. Nghỉ khoảng 900 ms giữa các niche để hạn chế scrape quá mức.
...
- Filter theo niche, score và thời gian.
...
6. Settings ElevenLabs hiện không cần cho flow mặc định và nên cân nhắc ẩn.
7. README cũ chưa phản ánh chức năng video renderer.
8. `solutionScript` chưa được hiển thị rõ trong panel và chưa được đưa vào file export.
9. Render progress hiện dùng chuỗi tiếng Việt cố định, chưa theo language setting.
10. Nếu người dùng cancel file picker, progress bar cần reset rõ ràng.
11. Chưa có estimate chi phí TTS trước khi render.
12. Card post dài cần scale động để tránh tràn khung hình.
